...
external_url 'https://git.nodevops.cn'
...
gitlab_rails['omniauth_providers'] = [
    {
       ...
       #'icon' => '<custom_provider_icon>',
        'args' => {
            ...
            'response_type' => 'code',
            'issuer' => 'https://keycloakx.ic110.cn/auth/realms/YunDun',
            'discovery' => true,
            ...
            'client_options' => {
                'identifier' => 'gitlab',
                'secret' => 'a4758833-c53c-4030-a150-13c5eaaf633e',
                'redirect_uri' => 'https://git.nodevops.cn/users/auth/openid_connect/callback'
            }
        }
    }
]
...
user['git_user_email'] = "gitlab@yundun.com"
