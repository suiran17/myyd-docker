...
# Create Database
# ------------------------------------------------------------
CREATE DATABASE IF NOT EXISTS apollo_config_uat DEFAULT CHARACTER SET = utf8mb4;

Use apollo_config_uat;
...
/* 更新部分配置 */
update ServerConfig set `Value`='true' where `Key`='namespace.lock.switch';
update ServerConfig set `Value`='http://172.16.100.200:10041/eureka/' where `Key`='eureka.service.url';
